...
System.Console.Write("Данная программа принимает два числа и выдаёт, какое число большее, а какое меньше.");
...
else {System.Console.Write($"Число {Value2} равно числу {Value1}");}

/* 
или так но на мой взгляд это лишнее (есть всего три варианта и они описаны выше)
для двух If значит если они не выполнятся выполнится else
