...
System.Console.WriteLine("Данная программа на вход принимает трёхзначное число и на выходе показывает цифру порядковый номер котрой будет введен");
...
if ( result == -2 ) {System.Console.WriteLine($"Введенное Вами число {chislo} имеет целых четыре знака");}
